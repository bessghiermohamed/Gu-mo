...
// (src/lib/ai/knowledge.ts) — كانت تُستعمل هنا وفي «المساعد الذكي» /api/ai
...
// ---------------------------------------------------------------------------
// مفاجأة صاحب المنصة (r81 — كانت نفس مفاجأة «المساعد الذكي» r80):
...
const AI_FALLBACK_TEXT =
  "خدمة الذكاء الاصطناعي غير متاحة حالياً (غير مضبوطة أو مثقلة مؤقتاً). جرّب بعد قليل — أو وثّق مصادرك واستخرج ملخصاتك في «دفتر طالب» داخل تطبيق طالب.";
