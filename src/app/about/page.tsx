...
export const metadata: Metadata = {
  ...
  description:
    "قصة منصة طالب: لماذا بُنيت، لمَن، ومبادئها — منصة جزائرية مستقلة تُطوَّر بإصغاء لطلبة المدرسة العليا للأساتذة بوزريعة.",
        ...
        <div className="mt-10 space-y-10 text-foreground/90">
          ...
          <section className="space-y-4">
            ...
            <p className="leading-loose">
              ...
              للأساتذة بوزريعة، وتوسعها التدريجي نحو مؤسسات جزائرية أخرى جارٍ
