...
const STEPS = [
  ...
  },
  {
    ...
    body: [
      "أول ما يفتح لك: اختيار المؤسسة (المدرسة العليا للأساتذة — بووزعادة)، ثم التخصص، ثم السنة الدراسية، ثم الشعبة. هذه الاختيارات تُخبر التطبيق أي مقررات وجدول يعرض لك — وبعدها لا تعود تختار شيئاً يدوياً.",
  ...
  },
  {
    ...
    body: [
      ...
      "لإضافة حصة شخصية: زر «حصة شخصية» أعلى الشاشة، ثم حدد اليوم والتوقيت واسم المادة والقاعة (مثلاً: مراجعة تحليل — قاعة المكتبة — السبت ١٠:٠٠). الحصة تظهر بلون كهرماني مميز مع شارة «شخصية»، وتعدّلها أو تحذفها من زرر القلم والسلة بجانبها.",
    ],
  },
  {
    title: "الخطوة الرابعة: تسجيل العلامات ومتابعة المعدل",
    body: [
      "من الخدمة «أدواتي» في الرئيسية (أو تبويب أدواتي داخل ملفاتي) افتح «حاسبة المعدل»: مقاييس تخصصك بمعاملاتها جاهزة، أدخل العلامة التي حصلت عليها في كل مقياس (مراقبة مستمرة، امتحان…) والمعدل يُحسب فوراً مع تفصيل كل مقياس، وبعد الحفظ يظهر معدلك في بطاقة الرئيسية.",
      "نصيحة من طلاب سبقوك: أدخل كل علامة يوم استلامها قبل أن تضيع الورقة. المعدل المحدَّث باستمرار يعطيك صورة حقيقية لمستواها في منتصف الفصل، حين يكون الوقت كافياً لتحسينه.",
    ],
  },
  {
    ...
    body: [
      ...
      "وداخل «ملفاتي» تجد تبويب «أدواتي»: سبع أدوات تعمل داخل جهازك دون إنترنت — حاسبة المعدل، تحويل الصور إلى PDF، ضغط PDF ودمجه، استخراج صفحات محددة منه، عدّاد الكلمات للتقارير، ومؤقّت مراجعة بأسلوب بومودورو.",
    ],
  },
  {
